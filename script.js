...
// object instances
// one instance for each state using new
var firstState = new State("IL", 5000, 12);
var secondState = new State("MN", 300, 3);
var thirdState = new State("NV", 25000, 1);

// push object instances to locations array
locations.push(firstState, secondState, thirdState);
...
//   locations.push(firstState[key])
// };
// console.log(locations);
// firstState.values(function(locations.push(this)));
// secondState.values(function(locations.push(this)));
// thirdState.values(function(locations.push(this)));
